...
#define FlashSize               (ProgramEnd - ProgramStart)//current soln:valid writing up to 0x7FFF
#define XRES			        640
#define YRES			        480
...
#define I2C_PreRegHigh	(*(volatile unsigned char *)(0x00408002))
#define I2C_PreRegLow	(*(volatile unsigned char *)(0x00408000))
#define I2C_CtrlReg		(*(volatile unsigned char *)(0x00408004))
#define I2C_TXReg		(*(volatile unsigned char *)(0x00408006))
#define I2C_RXReg		(*(volatile unsigned char *)(0x00408006))
#define I2C_CmdReg		(*(volatile unsigned char *)(0x00408008))
#define I2C_StaReg		(*(volatile unsigned char *)(0x00408008))
